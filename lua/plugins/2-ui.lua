...
return {
  ...
  -- Import the galaxyline configuration from lua/custom/galaxyline_config.lua
  require("custom.galaxyline_config")[1], -- Assuming the file returns a list with one plugin spec
